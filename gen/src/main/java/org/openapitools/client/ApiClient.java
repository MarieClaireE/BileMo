...
public class ApiClient {
    ...
    private String basePath = "http://api.bilemo.com/api";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.1.9/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://api.bilemo.com/api
